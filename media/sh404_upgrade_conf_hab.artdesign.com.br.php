...
// saved at: 2009-05-18 15:37:32
// by: admin (id: 62 )
// domain: http://hab.artdesign.com.br

if (!defined('_JEXEC')) die('Direct Access to this location is not allowed.');

$version = "1.0.19_Beta - build_232 - Joomla 1.5.x - <a href=\"http://extensions.siliana.com/\">extensions.Siliana.com</a>";
$Enabled = "0";
$replacement = "-";
$pagerep = "-";
...
$shInsertNumericalIdCatList = array("1","2","3","7","8","9","26","15","16","17","27","28","25","24","18","19","20","21","22","23");
...
$shLangTranslateList = array("pt-BR"=>"0","en-GB"=>"0");
$shLangInsertCodeList = array("pt-BR"=>"0","en-GB"=>"0");
$defaultComponentStringList = array("contact"=>"","content"=>"","jcrawler"=>"","newsfeeds"=>"","poll"=>"","search"=>"","user"=>"","virtuemart"=>"","weblinks"=>"","wrapper"=>"");
$pageTexts = array("en-GB"=>"Page-%s","pt-BR"=>"Page-%s");
...
$shSecCurMonth = "May-2009";
$shSecLastUpdated = 1242264244;
$shSecTotalAttacks = 0;
...
$debugStartedAt = 0;
$debugDuration = 3600;
$shInsertOutboundLinksImage = "1";
$shImageForOutboundLinks = "external-black.png";
$useCatAlias = "0";
$useSecAlias = "0";
$useMenuAlias = "0";
$shEnableTableLessOutput = "1";
