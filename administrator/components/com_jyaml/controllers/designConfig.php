 ...
 *
 * @version         $Id: designConfig.php 429 2008-07-04 16:12:06Z hieblmedia $
...
class hmyamlControllerDesignConfig extends hmyamlController
{
  /**
  ...
  function edit()
  {
    ...
    JRequest::setVar( 'view', 'hmyamldesignconf' );
